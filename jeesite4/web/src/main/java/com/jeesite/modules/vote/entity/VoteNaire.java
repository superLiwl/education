...
@Table(name="vote_naire", alias="a", columns={
		...
		@Column(name="content", attrName="content", label="问卷描述", isQuery=false),
		@Column(name="create_time", attrName="createTime", label="创建时间", isInsert=false, isUpdate=false, isQuery=false),
		@Column(name="statues", attrName="statues", label="状态", comment="状态：1-草稿，2-发布，3-结束", isInsert=false, isUpdate=false, isQuery=false),
		@Column(name="del_flag", attrName="delFlag", label="0-未删除，1-已删除", isInsert=false, isUpdate=false, isQuery=false),
