...
public class HasCheckedExportCsVo {
    ...
    @ExcelFields({@com.jeesite.common.utils.excel.annotation.ExcelField(title = "参评单位", attrName = "officeName", align = com.jeesite.common.utils.excel.annotation.ExcelField.Align.CENTER, sort = 30),
            @com.jeesite.common.utils.excel.annotation.ExcelField(title = "处室", attrName = "optionName", align = com.jeesite.common.utils.excel.annotation.ExcelField.Align.LEFT, sort = 50)})
    public HasCheckedExportCsVo getVoteInfoExportVo(HasCheckedExportCsVo vo) {
        return vo;
    }
