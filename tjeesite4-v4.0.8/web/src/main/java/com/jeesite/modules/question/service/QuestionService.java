    ...
    public void save(Question voteQuestion) {
        ...
        for (Options voteOptions : voteQuestion.getVoteOptionsList()) {
            if (!Options.STATUS_DELETE.equals(voteOptions.getStatus())) {
                ...
                if (null != voteOptions.getTitle() && !"".equals(voteOptions.getTitle()) && !"".equals(voteOptions.getTitle().trim())) {
        ...
        for (Options voteOptions : voteQuestion.getVoteOptionsList()) {
            if (!Options.STATUS_DELETE.equals(voteOptions.getStatus()) && null != voteOptions.getTitle() && !"".equals(voteOptions.getTitle()) && !"".equals(voteOptions.getTitle().trim())) {
                ...
                sub.setTreeLevel("1");
                sub.setTreeLeaf(voteOptions.getUrl());
                subList.add(sub);
            }
        }
